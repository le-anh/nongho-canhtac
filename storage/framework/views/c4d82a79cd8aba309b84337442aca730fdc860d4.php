...
<head>
	...
	<link rel="stylesheet" href=" <?php echo e(asset('public/admin/admin/vendor/open-iconic/css/open-iconic-bootstrap.min.css')); ?> " />
				...
				<div class="aside-menu overflow-hidden">
					...
					<nav id="stacked-menu" class="stacked-menu">
						...
						<ul class="menu">
							...
							<li class="menu-item has-child">
								<a href="#" class="menu-link"><span class="menu-icon oi oi-wrench"></span> <span class="menu-text">Auth</span></a> 
								<ul class="menu">
									<li class="menu-item">
							...
							<li class="menu-item has-child">
								<a href="#" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text">Layouts</span> <span class="badge badge-subtle badge-success">+4</span></a> 
								<ul class="menu">
									<li class="menu-item">
							...
							<li class="menu-item has-child">
								<a href="#" class="menu-link"><span class="menu-icon oi oi-pencil"></span> <span class="menu-text">Forms</span></a> 
								<ul class="menu">
									<li class="menu-item">
							...
							<li class="menu-item has-child">
								<a href="#" class="menu-link"><span class="menu-icon fas fa-table"></span> <span class="menu-text">Tables</span></a> 
								<ul class="menu">
									<li class="menu-item">
							...
							<li class="menu-item has-child">
								<a href="#" class="menu-link"><span class="menu-icon oi oi-bar-chart"></span> <span class="menu-text">Collections</span></a> 
								<ul class="menu">
									<li class="menu-item has-child">
...
</html><?php /**PATH /mnt/DATA/www/htxtravinh/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>