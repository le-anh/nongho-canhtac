...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <div class="d-md-flex align-items-md-start">
      <h1 class="page-title mr-sm-auto"> Giai đoạn quy trình <small> Tạo mới </small> </h1>
    </div>
  </header>
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('farmer.giaidoanquytrinh.store') }} " method="post">
          @csrf()
          <fieldset>
			...
			<div class="form-group">
              ...
              <input type="text" class="form-control @error('tengiaidoan') is-invalid @enderror" id="tengiaidoan" name="tengiaidoan" value="{{old('tengiaidoan')}}" placeholder="Tên giai đoạn" autofocus>
			...
			<div class="form-group">
              ...
              <textarea class="form-control @error('huongdan') is-invalid @enderror" id="huongdan" name="huongdan" rows="2" placeholder="Hướng dẫn" autofocus>{{old('huongdan')}}</textarea>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('phuongphap') is-invalid @enderror" id="phuongphap" name="phuongphap" rows="2" placeholder="Phương pháp" autofocus>{{old('phuongphap')}}</textarea>
