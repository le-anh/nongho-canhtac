...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <div class="d-md-flex align-items-md-start">
      <h1 class="page-title mr-sm-auto"> Quy trình <small> Chỉnh sửa </small> </h1>
    </div>
  </header>
  <div class="page-section">
    <div class="card card-fluid">
      <div class="card-body">
        ...
        <form action=" {{ route('farmer.quytrinh.update') }} " method="post" enctype="multipart/form-data">
          @csrf()
          @method('PUT')
          <input type="hidden" name="quytrinhid" value=" {{ $quyTrinh->id }} ">
          <fieldset>
			<div class="form-group">
              <label for="tenquytrinh">Tên quy trình <abbr title="Required">*</abbr></label>
              <input type="text" class="form-control @error('tenquytrinh') is-invalid @enderror" id="tenquytrinh" name="tenquytrinh" value="{{old('tenquytrinh',  $quyTrinh->tenquytrinh)}}" placeholder="Tên quy trình" autofocus>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('mota') is-invalid @enderror" id="mota" name="mota" rows="3" placeholder="Mô tả" autofocus>{{old('mota', $quyTrinh->mota)}}</textarea>
