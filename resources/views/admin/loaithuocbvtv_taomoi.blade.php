...
<div class="container rounded">
  <div class="title">
    <h5 class="pull-left"><strong>Loại thuốc bvtv <small> (tạo mới) </small></strong></h5>
    <a href="{{route('admin.loaithuocbvtv.trangchu')}}" class="btn btn-info pull-right"> <i class="fa fa-arrow-circle-left"></i></a>
  </div>
  <div>
    <form action="{{route('admin.loaithuocbvtv.luu')}}" method="post">
        @csrf()
        ...
        <div class="form-group">
            ...
            <input type="text" name="tenloaithuocbvtv" id="tenloaithuocbvtv" class="form-control @error('tenloaithuocbvtv') is-invalid @enderror" value="{{old('tenloaithuocbvtv')}}" placeholder="Tên loại thuốc bvtv" autofocus>
